...
url_interface = 'interface.php?ui=pc';
currMosshaf = 'hafs';
...
function getTranslation( page ){
	...
	if( ! tarajem[currTarjama][currMosshaf][page]){
		...
		jxr['tafsir'] = $.get(url + "&b_sura="+b_sura+"&b_aya="+b_aya+"&e_sura="+e_sura+"&e_aya="+e_aya+"&11" , function(json){
...
function doTafsir(author , obj){
	...
	xhr.done(function(bayan){
		var win_url = "http://212.57.192.148/tafseer/"+((auTrans[author])?auTrans[author]:author)+"/sura"+sura+"-aya"+aya+".html";
	...
	var sura  = currAya.split('_')[0];
	var aya   = currAya.split('_')[1];
	var hp    = url_interface + '&do=tafsir&author=' + author + '&sura='+currAya.split('_')[0] + '&aya='+currAya.split('_')[1];
	$obj.data('xhr' , $.get(hp));
...
$(function() {
	...
	$("#share_fb").click(function(){
		var url = encodeURIComponent('http://212.57.192.148/index.php?l='+logha+'&c=5');
	...
	$("#share_twt").click(function(){
		...
		var url = _lang['sh_desc'] + ' : ' + encodeURIComponent('http://212.57.192.148/index.php?l='+logha);
